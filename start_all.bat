...
start "Django Backend" cmd /k "cd django_taxi_analysis && ..\.venv\Scripts\python.exe manage.py runserver 0.0.0.0:8000"
...
:: 启动人脸识别服务
echo [信息] 启动CV2人脸识别服务...
start "Face Recognition" cmd /k "cd face-recognition-cv2-master\face-recognition-cv2-master && ..\..\.venv\Scripts\python.exe face_api.py"
